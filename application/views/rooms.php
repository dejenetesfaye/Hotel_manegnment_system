...
<body>
    ...
    <!-- Hero Section Begin -->
    <section class="hero-section set-bg" data-setbg="<?php echo $this->config->item('base_url'); ?>img/rooms-bg.jpg">
        <div class="hero-text">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="page-nav">
                    <a href='<?php echo base_url()."index.php/Welcome/services"; ?>' class="left-nav"><i class="lnr lnr-arrow-left"></i> Services</a>
                    <a href='<?php echo base_url()."index.php/Welcome/news"; ?>' class="right-nav">News <i class="lnr lnr-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-6">
                        <div class="room-pic-slider owl-carousel">
                            <div class="single-room-pic">
								<img src="<?php echo $this->config->item('base_url'); ?>img/room/rooms-1.jpg" alt="">
                            </div>
                            <div class="single-room-pic">
								<img src="<?php echo $this->config->item('base_url'); ?>img/room/rooms-2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="room-text">
                            <div class="room-title">
                                ...
                                <div class="room-price">
                                    ...
                                    <h2><?php foreach($posts as $post): ?>
									$<?php echo $post['cost']?></h2>
									<?php endforeach; ?>
                            ...
                            <a href='<?php echo base_url()."index.php/Welcome/book_sd_room"; ?>' class="primary-btn" >Book Now <i class="lnr lnr-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
			<div class="rooms-page-item">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="room-pic-slider owl-carousel">
                            <div class="single-room-pic">
								<img src="<?php echo $this->config->item('base_url'); ?>img/room/rooms-3.jpg" alt="">
                        ...
                        <div class="room-text">
                            <div class="room-title">
                                ...
                                <div class="room-price">
									...
									<h2><?php foreach($costs as $cost): ?>
									$<?php echo $cost['cost']?></h2>
									<?php endforeach; ?> 
							...
							<a href='<?php echo base_url()."index.php/Welcome/book_db_room"; ?>' class="primary-btn" >Book Now <i class="lnr lnr-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="rooms-page-item">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="room-pic-slider owl-carousel">
                            <div class="single-room-pic">
								<img src="<?php echo $this->config->item('base_url'); ?>img/room/rooms-4.jpg" alt="">
                            </div>
                            <div class="single-room-pic">
								<img src="<?php echo $this->config->item('base_url'); ?>img/room/rooms-2.jpg" alt="">
                            </div>
                        ...
                        <div class="room-text">
                            <div class="room-title">
                                ...
                                <div class="room-price">
									...
									<h2><?php foreach($prices as $price): ?>
									$<?php echo $price['cost']?></h2>
									<?php endforeach; ?> 
							...
							<a href='<?php echo base_url()."index.php/Welcome/book_sp_room"; ?>' class="primary-btn" >Book Now <i class="lnr lnr-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
