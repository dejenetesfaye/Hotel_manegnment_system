...
<body>
    ...
    <!-- Hero Section Begin -->
    <section class="hero-section set-bg" data-setbg="<?php echo $this->config->item('base_url'); ?>img/contact-bg.jpg">
        <div class="hero-text">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="page-nav">
                    <a href='<?php echo base_url()."index.php/Welcome/news"; ?>'></i> News</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-6">
                    <div class="contact-left">
                        <div class="contact-information">
                            ...
                            <ul>
                                <li><img src="<?php echo $this->config->item('base_url'); ?>img/placeholder-copy.png" alt=""><span>1525 Boring Lane, Los Angeles,
                                        CA</span></li>
                                <li><img src="<?php echo $this->config->item('base_url'); ?>img/phone-copy.png" alt=""> <span>+1 (603)535-4592</span></li>
								<li><img src="<?php echo $this->config->item('base_url'); ?>img/envelop.png" alt=""> <span>+1 (603)535-4592</span></li>
								<li><img src="<?php echo $this->config->item('base_url'); ?>img/clock-copy.png" alt=""> <span>+1 (603)535-4592</span></li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <img src="<?php echo $this->config->item('base_url'); ?>img/edit.png" alt=""> 
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="email" placeholder="Email">
                                        <img src="<?php echo $this->config->item('base_url'); ?>img/envelop-copy.png" alt=""> 
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-group phone-num">
                                        <input type="text" placeholder="Phone">
                                        <img src="<?php echo $this->config->item('base_url'); ?>img/phone-copy.png" alt=""> 
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="message">
                                        ...
                                        <div class="textarea">
                                            ...
                                            <img src="<?php echo $this->config->item('base_url'); ?>img/speech-copy.png" alt=""> 
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
