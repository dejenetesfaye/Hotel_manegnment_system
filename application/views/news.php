    ...
    <section class="hero-section set-bg" data-setbg="<?php echo $this->config->item('base_url'); ?>img/services-bg.jpg">
        <div class="hero-text">
            <div class="container">
                ...
                <div class="page-nav">
                    <a href='<?php echo base_url()."index.php/Welcome/rooms"; ?>' class="left-nav"><i class="lnr lnr-arrow-left"></i>Rooms</a>
                    <a href='<?php echo base_url()."index.php/Welcome/contact"; ?>' class="right-nav">Contact <i class="lnr lnr-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="recent-post">
                            ...
                            <div class="single-recent-post">
                                <div class="recent-pic">
									<img src="<?php echo $this->config->item('base_url'); ?>img/blog/recent-1.jpg" alt="">
                                </div>
                            ...
                            <div class="single-recent-post">
                                <div class="recent-pic">
									<img src="<?php echo $this->config->item('base_url'); ?>img/blog/recent-2.jpg" alt="">
                                </div>
                                <div class="recent-text">
                            ...
                            <div class="single-recent-post">
                                <div class="recent-pic">
									<img src="<?php echo $this->config->item('base_url'); ?>img/blog/recent-3.jpg" alt="">
                                </div>
                                <div class="recent-text">
                ...
                <div class="col-lg-8 order-1 order-lg-2">
                    <div class="blog-post">
                        <div class="single-blog-post">
                            <div class="blog-pic">
								<img src="<?php echo $this->config->item('base_url'); ?>img/blog/blog-1.jpg" alt="">
                            </div>
                            <div class="blog-text">
                                ...
                                <div class="blog-widget">
                                    ...
                                    <div class="blog-info">
										<img src="<?php echo $this->config->item('base_url'); ?>img/blog/blog-2.jpg" alt="">
                                        <span>February 17, 2018</span>
                                    </div>
                                    <div class="blog-info">
										<img src="<?php echo $this->config->item('base_url'); ?>img/blog/blog-3.jpg" alt="">
                        ...
                        <div class="single-blog-post">
                            ...
                            <div class="blog-text">
                                ...
                                <div class="blog-widget">
                                    ...
                                    <div class="blog-info">
										<img src="<?php echo $this->config->item('base_url'); ?>img/clock.png" alt="">
                                        <span>February 17, 2018</span>
                                    </div>
                                    <div class="blog-info">
										<img src="<?php echo $this->config->item('base_url'); ?>img/speech.png" alt="">
                                        <span>4 Comments</span>
                                    </div>
                                    <div class="blog-info">
                                        <i class="fa fa-folder-o"></i>
