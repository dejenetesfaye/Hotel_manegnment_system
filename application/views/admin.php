                ...
                <div class="container">
                    <nav class="main-menu mobile-menu">
                        <ul>
							...
							<li><a href='<?php echo base_url()."index.php/Welcome/signin"; ?>'>signin</a></li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="container">
					  <fieldset>
						<legend>standard Room Book</legend>
							<div class="limiter">
							<div  style="background-image: url(<?php echo $this->config->item('base_url'); ?>img/services/services-5.jpg);">
